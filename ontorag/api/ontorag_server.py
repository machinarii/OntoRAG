...
from ontorag import OntoRAG, ROLES, RoleLLMConfig, __version__ as core_version
...
from ontorag.api.routers.document_routes import (
    DocumentManager,
...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding == "gemini":
            from ontorag.llm.binding_options import GeminiLLMOptions
        ...
        if args.llm_binding == "bedrock":
            from ontorag.llm.binding_options import BedrockLLMOptions
...
def check_frontend_build():
    ...
    if not index_html.exists():
        ...
        ASCIIColors.cyan("    cd ontorag_webui")
    ...
    try:
        source_dir = Path(__file__).parent.parent.parent / "ontorag_webui"
        ...
        # Key configuration files (in ontorag_webui root directory)
        key_files = [
...
def create_app(args):
    ...
    api_key = os.getenv("ONTORAG_API_KEY") or args.key
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            ...
            if "ONTORAG_GUNICORN_MODE" not in os.environ:
    ...
    def get_workspace_from_request(request: Request) -> str | None:
        ...
        'ONTORAG-WORKSPACE' header. If not present, falls back to the
        ...
        workspace = request.headers.get("ONTORAG-WORKSPACE", "").strip()
    ...
    def create_optimized_azure_openai_llm_func(
        ...
        async def optimized_azure_openai_model_complete(
            ...
            **kwargs,
            ...
            from ontorag.llm.azure_openai import azure_openai_complete_if_cache
    ...
    def create_llm_model_func(binding: str):
        ...
        try:
            if binding == "lollms":
                from ontorag.llm.lollms import lollms_model_complete

                return lollms_model_complete
            elif binding == "ollama":
                from ontorag.llm.ollama import ollama_model_complete
    ...
    def create_role_llm_func(role: str, override_meta: dict | None = None):
        ...
        try:
            if role_binding == "ollama":
                from ontorag.llm.ollama import _ollama_model_if_cache
            ...
            if role_binding == "lollms":
                from ontorag.llm.lollms import lollms_model_if_cache
            ...
            if role_binding == "bedrock":
                from ontorag.llm.bedrock import bedrock_complete_if_cache
    ...
    from ontorag.api.config import OllamaServerInfos

    ollama_server_infos = OllamaServerInfos(
        name=args.simulated_model_name, tag=args.simulated_model_tag
    )

    # OntoRAG.__post_init__ normalizes addon_params and backfills env-based defaults
    ...
    try:
        ...
        logger.error(f"Failed to initialize OntoRAG: {e}")
        raise
...
def configure_logging():
    ...
    for logger_name in ["uvicorn", "uvicorn.access", "uvicorn.error", "ontorag"]:
    ...
    print(f"\nOntoRAG log file: {log_file_path}\n")
    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "path_filter": {
                    "()": "ontorag.utils.OntoragPathFilter",
                },
            },
        }
    )
...
def main():
    ...
    # See: https://github.com/machinarii/OntoRAG/issues/2438
