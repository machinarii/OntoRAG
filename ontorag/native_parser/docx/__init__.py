"""OntoRAG native DOCX parser package.
...
:meth:`ontorag.pipeline._PipelineMixin.parse_native` so the native and
MinerU engines share one shape; see :mod:`ontorag.native_parser.docx.ir_builder`
