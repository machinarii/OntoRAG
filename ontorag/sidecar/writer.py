...
This module is the *single executable specification* of the OntoRAG sidecar
format (``docs/OntoRAGSidecarFormat-zh.md``). Engine adapters hand it an
...
from ontorag.sidecar.placeholders import (
    render_drawing_tag,
    render_equation_tag,
    render_table_tag,
    render_template,
...
from ontorag.table_markup import header_grid_to_thead_html
from ontorag.utils import logger, strip_control_characters
