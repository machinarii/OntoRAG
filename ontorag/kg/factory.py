...
from ontorag.kg import STORAGES
...
def get_storage_class(storage_name: str) -> Callable[..., Any]:
    ...
    # against the top-level ``ontorag`` package, so anchor the import there
    # rather than letting it resolve against this module's own package.
    import_path = STORAGES[storage_name]
    module = importlib.import_module(import_path, package="ontorag")
