...
class MilvusVectorDBStorage(BaseVectorStorage):
    ...
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if self.namespace.endswith("entities"):
            ...
            description = "OntoRAG entities vector storage"
            ...
            description = "OntoRAG relationships vector storage"
            ...
            description = "OntoRAG chunks vector storage"
            ...
            description = "OntoRAG generic vector storage"
    ...
    def _validate_collection_and_load(self) -> None:
        try:
            ...
            logger.error(
                f"[{self.workspace}] 4. Consider recreating the collection using: ontorag-rebuild-vdb "
            )
            logger.error(
