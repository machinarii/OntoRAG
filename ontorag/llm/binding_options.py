...
from ontorag.constants import DEFAULT_TEMPERATURE
...
# in OntoRAG. It provides a standardized framework for:
#
...
class BindingOptions:
    ...
    def generate_dot_env_sample(cls):
        """
        Generate a sample .env file for all OntoRAG binding options.
        ...
        sample_top = (
            ...
            + "\n"
            + (
                "# Autogenerated .env entries list for OntoRAG binding options\n"
                "#\n"
                "# To generate run:\n"
...
# inferenceConfig that OntoRAG's bedrock driver actually forwards. See
# ``ontorag/llm/bedrock.py`` for the whitelist — any field added here that is
...
#
# Usage:
#   python -m ontorag.llm.binding_options           # Generate .env sample
#   python -m ontorag.llm.binding_options test      # Test argument parsing
#
# =============================================================================
