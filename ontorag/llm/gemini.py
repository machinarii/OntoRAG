"""
Gemini LLM binding for OntoRAG.

This module provides asynchronous helpers that adapt Google's Gemini models
to the same interface used by the rest of the OntoRAG LLM bindings. The
...
def _normalize_gemini_response_schema(response_format: Any) -> Any | None:
    """Extract a Gemini-compatible JSON schema from OntoRAG/OpenAI inputs."""
...
async def gemini_complete_if_cache(
    ...
    **_: Any,
    ...
    Args:
        ...
        max_tokens: Generic output-length cap (as forwarded via OntoRAG's
