...
Reads a OntoRAG ``.blocks.jsonl`` artifact (produced by the docx native
...
``ontorag/native_parser/docx/parse_document.py``.
...
# ontorag/native_parser/docx/parse_document.py so the trade-off curves
...
def _split_long_block(
    ...
    *,
    ...
    Mirrors :func:`ontorag.native_parser.docx.parse_document.split_long_block`,
...
def _merge_small_blocks(
    ...
    *,
    ...
    :func:`ontorag.native_parser.docx.parse_document.merge_small_blocks`,
