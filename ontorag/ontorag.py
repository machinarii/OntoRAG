...
from ontorag.utils_pipeline import normalize_document_file_path
...
class OntoRAG(_RoleLLMMixin, _StorageMigrationMixin, _PipelineMixin):
    ...
    :func:`ontorag.parser_routing.default_chunker_config`.  Per-doc
    ...
    **When this function is actually invoked.** The chunker dispatch in
    ...
    :attr:`ontorag.parser_routing.ProcessOptions.chunking_explicit`.
    ...
    **Signature** — preserved unchanged from earlier OntoRAG releases
    ...
    def _apply_chunk_size_overlay(self) -> None:
        ...
        2. Strategy-specific env (``CHUNK_F_OVERLAP_SIZE`` /
           ...
           :func:`ontorag.parser_routing.default_chunker_config` *only*
