...
from ontorag.constants import PARSER_ENGINE_NATIVE
from ontorag.parser.docx.zip_budget import enforce_docx_decompression_budget
...
class NativeDocxParser(NativeParserBase):
    """Native DOCX parser for OntoRAG's production parsing path.
    ...
    def extract(
        ...
        *,
        ...
        from ontorag.parser.docx.drawing_image_extractor import (
            DrawingExtractionContext,
            load_relationships,
        )
        from ontorag.parser.docx.parse_document import extract_docx_blocks
    ...
    def build_ir(
        ...
        *,
        ...
        from ontorag.parser.docx.ir_builder import NativeDocxIRBuilder
