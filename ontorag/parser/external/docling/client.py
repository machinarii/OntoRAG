...
from ontorag.parser.external._zip import result_bundle_limits, safe_extract_zip
from ontorag.parser.external.docling.cache import (
    compute_options_signature,
    current_endpoint_signature,
    snapshot_tunable_env,
)
from ontorag.parser.external.docling.manifest import (
...
class DoclingRawClient:
    ...
    async def download_into(
        ...
        *,
        ...
        :func:`ontorag.parser.external.clear_dir_contents`). This method
