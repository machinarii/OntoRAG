...
- :class:`ontorag.parser.markdown.ir_builder.NativeMarkdownIRBuilder` later
...
from ontorag.parser._html_table import starts_with_html_tag
from ontorag.parser._markdown import render_heading_line
