...
from ontorag.prompt import PROMPTS, resolve_entity_extraction_prompt_profile
...
def _warn_deprecated_query_model_func(context: str) -> None:
    warnings.warn(
        ...
        "Use OntoRAG.aupdate_llm_role_config() instead. "
...
def _parse_mm_display_name(content: str, fallback: str) -> str:
    ...
    ``OntoRAG._build_mm_chunks_from_sidecars`` — the producer-side
...
async def extract_entities(
    ...
    if prompt_profile is None:
        ...
        # path that OntoRAG.__post_init__ populates, instead of duplicating
