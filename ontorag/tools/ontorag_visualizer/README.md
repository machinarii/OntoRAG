# OntoRAG 3D Graph Viewer

An interactive 3D graph visualization tool included in the OntoRAG package for visualizing and analyzing RAG (Retrieval-Augmented Generation) graphs and other graph structures.
...
### Quick Install
```bash
pip install ontorag-hku[tools]  # Install with visualization tool only
# or
pip install ontorag-hku[api,tools]  # Install with both API and visualization tools
```
...
1. **Command Not Found**
   ...
   pip install ontorag-hku[tools]

   # Verify installation
   pip list | grep ontorag-hku
   ```
...
- GitHub Issues: [OntoRAG Repository](https://github.com/machinarii/OntoRAG)
- Documentation: [OntoRAG Docs](https://URL-to-docs)

## License

This tool is part of OntoRAG and is distributed under the MIT License. See `LICENSE` for more information.

Note: This visualization tool is an optional component of the OntoRAG package. Install with the [tools] option to access the viewer functionality.
