#!/usr/bin/env python3
"""
LLM Query Cache Cleanup Tool for OntoRAG
...
Usage:
    python -m ontorag.tools.clean_llm_query_cache
    # or
    python ontorag/tools/clean_llm_query_cache.py
...
from ontorag.kg.shared_storage import set_all_update_flags
...
class CleanupTool:
    ...
    def get_storage_class(self, storage_name: str):
        ...
        if storage_name == "JsonKVStorage":
            ...
            from ontorag.kg.redis_impl import RedisKVStorage

            return RedisKVStorage
        elif storage_name == "PGKVStorage":
            from ontorag.kg.postgres_impl import PGKVStorage

            return PGKVStorage
        elif storage_name == "MongoKVStorage":
            from ontorag.kg.mongo_impl import MongoKVStorage

            return MongoKVStorage
        elif storage_name == "OpenSearchKVStorage":
            from ontorag.kg.opensearch_impl import OpenSearchKVStorage
    ...
    def print_header(self):
        """Print tool header"""
        print("\n" + "=" * 60)
        print("LLM Query Cache Cleanup Tool - OntoRAG")
        print("=" * 60)
    ...
    async def setup_storage(self) -> tuple:
        ...
        if storage_name == "JsonKVStorage":
            ...
            print("  • OntoRAG Server is completely shut down")
