...
ONTORAG_* storage env vars; server-backend deployments should prefer the
library call from a small script wired to their own OntoRAG construction):

    python -m ontorag.tools.kg_integrity_repair [--apply] [--verbose]
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Audit (and optionally repair) OntoRAG per-document "
