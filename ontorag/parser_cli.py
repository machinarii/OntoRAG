...
Drives ``OntoRAG.parse_<engine>`` against a single source file and writes
...
Invocation::
    ...
    python -m ontorag.parser_cli path/to/sample.docx --engine native
    python -m ontorag.parser_cli path/to/sample.pdf  --engine mineru
    python -m ontorag.parser_cli path/to/sample.pdf  --engine docling --force-reparse
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="parse_sidecar",
        description=(
            "Run OntoRAG.parse_<engine> on a single file and emit sidecar "
...
async def _run(args: argparse.Namespace) -> int:
    ...
    from ontorag.parser_debug import build_debug_rag
