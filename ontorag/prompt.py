...
def load_user_prompt_prefix_source() -> str:
    ...
    naturally ends with one). See :func:`ontorag.utils.resolve_user_prompt`.

    Never raises: this runs inside ``OntoRAG()`` via a dataclass
    ...
    try:
        ...
        # escape would abort every OntoRAG() construction, since this runs as a
