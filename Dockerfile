...
RUN mkdir -p /app/data/tiktoken \
    && uv run ontorag-download-cache --cache-dir /app/data/tiktoken --spacy-dir /app/spacy_models || status=$?; \
...
RUN apt-get update \
    ...
    && chown -R ontorag:ontorag /app /home/ontorag
...
ENV HOME=/home/ontorag \
    XDG_CACHE_HOME=/home/ontorag/.cache \
    PIP_CACHE_DIR=/home/ontorag/.cache/pip \
    UV_CACHE_DIR=/home/ontorag/.cache/uv

# Entrypoint starts as root, fixes mount ownership, then drops to ontorag.
...
CMD ["python", "-m", "ontorag.api.ontorag_server"]
