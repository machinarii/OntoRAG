...
helm upgrade --install ontorag-dev $SCRIPT_DIR/ontorag \
  --namespace rag \
...
# Wait for OntoRAG pod to be ready
echo ""
echo "Waiting for ontorag-dev pod to be ready..."
kubectl wait --for=condition=ready pod -l app.kubernetes.io/instance=ontorag-dev --timeout=300s -n rag
echo "ontorag-dev pod is ready"
echo ""
echo "Running Port-Forward:"
echo "    kubectl --namespace rag port-forward svc/ontorag-dev 9621:9621"
echo "==========================================="
echo ""
echo "✅ You can visit OntoRAG at: http://localhost:9621"
echo ""
