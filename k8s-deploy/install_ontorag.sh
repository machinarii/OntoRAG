...
echo "Deploying production OntoRAG (using external databases)..."
...
helm upgrade --install ontorag $SCRIPT_DIR/ontorag \
  --namespace $NAMESPACE \
...
echo ""
echo "Waiting for ontorag pod to be ready..."
kubectl wait --for=condition=ready pod -l app.kubernetes.io/instance=ontorag --timeout=300s -n rag
echo "ontorag pod is ready"
echo ""
echo "Running Port-Forward:"
echo "    kubectl --namespace rag port-forward svc/ontorag 9621:9621"
echo "==========================================="
echo ""
