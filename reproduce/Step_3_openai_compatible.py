...
from ontorag.utils import EmbeddingFunc, always_get_an_event_loop
import numpy as np


## For Upstage API
# please check if embedding_dim=4096 in ontorag.py and llm.py in ontorag direcotry
...
if __name__ == "__main__":
    ...
    rag = OntoRAG(working_dir=WORKING_DIR)
    rag = OntoRAG(
