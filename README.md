...
- **[pdf2md](https://github.com/machinarii/pdf2md)** — a separately maintained structure-aware PDF / EPUB / DOCX → Markdown converter, pinned as the `external/pdf2md` Git submodule. OntoRAG keeps only its adapter. See [setup and updates](docs/Pdf2MdIntegration.md).
