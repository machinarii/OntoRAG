...
type RoleLLMRow = {
  role: string
  config: OntoragRoleLLMConfig
  queue?: OntoragQueueStatus
}
...
type MinerUStatus = NonNullable<OntoragStatus['configuration']['mineru']>
type DoclingStatus = NonNullable<OntoragStatus['configuration']['docling']>
...
const getModelRows = (status: OntoragStatus): RoleLLMRow[] => {
...
const StatusCard = ({ status }: { status: OntoragStatus | null }) => {
