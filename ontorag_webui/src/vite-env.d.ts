...
interface ImportMetaEnv {
   ...
   * into `index.html` as `window.__ONTORAG_CONFIG__`, mirroring what the
   ...
   *
   * See `ontorag_webui/env.development.smaple` and
   ...
   *  `ONTORAG_API_PREFIX` if a real prefixed backend is being proxied to. */
