 ...
 *
 * The entry HTML ships a static `<title>OntoRAG</title>`, which a deployment
...
export const DEFAULT_DOCUMENT_TITLE = 'OntoRAG'
 ...
 * title and must leave the static `OntoRAG` in the tab. Falling through to
