"""
OntoRAG Data Isolation Demo: Workspace Management

This example demonstrates how to maintain multiple isolated knowledge bases
within a single application using OntoRAG's 'workspace' feature.
...
Usage:
    python ontorag_workspace_demo.py
"""
...
async def initialize_rag(
    ...
    """
    Initializes a OntoRAG instance with data isolation.

    Entity type guidance can be customized by passing
    addon_params={'entity_types_guidance': '...'} to OntoRAG.
    """
...
async def main():
    ...
    try:
        ...
        print("Initializing isolated OntoRAG workspaces...")
