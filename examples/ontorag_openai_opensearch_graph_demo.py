"""
OntoRAG Demo with OpenSearch + OpenAI
...
2. Required indices will be auto-created by OntoRAG
...
from ontorag.utils import setup_logger, EmbeddingFunc
...
async def main():
    rag = None
    try:
        print("Initializing OntoRAG with OpenSearch + OpenAI...")
