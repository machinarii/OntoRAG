"""
OntoRAG Demo with PostgreSQL + Google Gemini

This example demonstrates how to use OntoRAG with:
...
2. Required tables will be auto-created by OntoRAG
...
Usage:
    python examples/ontorag_postgres_demo.py
"""
...
from ontorag.utils import setup_logger, wrap_embedding_func_with_attrs
...
# --------------------------------------------------
async def initialize_rag() -> OntoRAG:
    rag = OntoRAG(
...
async def main():
    rag = None
    try:
        print("Initializing OntoRAG with PostgreSQL + Gemini...")
        ...
        print("\nInserting document into OntoRAG (this may take some time)...")
