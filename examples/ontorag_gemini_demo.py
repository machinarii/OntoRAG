"""
OntoRAG Demo with Google Gemini Models

This example demonstrates how to use OntoRAG with Google's Gemini 2.0 Flash model
...
Usage:
    python examples/ontorag_gemini_demo.py
"""
