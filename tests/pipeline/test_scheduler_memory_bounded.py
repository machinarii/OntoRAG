...
from ontorag.base import CURSOR_END, CURSOR_START, CursorAfter, DocStatus
from ontorag.pipeline import _AUTO_RESUME_DOC_STATUSES, _PipelineMixin
...
class _SyntheticDocStatus:
    ...
    async def get_docs_by_statuses_page(
        ...
        from ontorag.base import DocSchedulingRecord, DocStatusPage
    ...
    async def get_full_docs_by_ids(self, ids, *, strict=False):
        ...
        from ontorag.base import DocProcessingStatus
