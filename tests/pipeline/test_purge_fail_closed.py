...
from ontorag.utils_pipeline import make_kg_purge_operation_id
...
def _assert_nothing_deleted(rag: OntoRAG) -> None:
...
async def _purge(rag: OntoRAG, chunk_ids: list[str], doc_id: str = DOC):
    status, lock = _status()
