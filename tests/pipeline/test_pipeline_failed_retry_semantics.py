...
async def _build_rag(tmp_path, workspace: str, extract: _CountingExtract) -> OntoRAG:
    rag = OntoRAG(
...
async def _make_failed_doc(rag: OntoRAG, name: str, extract: _CountingExtract) -> str:
