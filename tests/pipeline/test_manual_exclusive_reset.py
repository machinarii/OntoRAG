...
from ontorag.base import CURSOR_START, DocStatus
...
async def _build_rag(tmp_path, extract: _CountingExtract) -> OntoRAG:
    rag = OntoRAG(
...
async def _make_failed(rag: OntoRAG, name: str, extract: _CountingExtract) -> str:
    extract.fail = True
...
def test_next_failed_page_single_scan_when_paging_off(tmp_path):
    ...
    async def _run():
        ...
        try:
            ...
            from ontorag.base import CURSOR_END
