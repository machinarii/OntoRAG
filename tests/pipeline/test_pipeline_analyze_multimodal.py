...
def test_structurally_starved_config_warns_once(caplog, _propagate_ontorag_logger):
    ...
    from ontorag.pipeline import _warn_content_budget_structurally_starved
...
def test_table_content_format_label_html_and_json():
    from ontorag.prompt_multimodal import table_content_format_label
...
async def test_truncated_vlm_response_not_cached_and_recomputed(tmp_path):
    ...
    """
    from ontorag.utils import TruncatedResponse
