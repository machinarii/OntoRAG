...
ONTORAG_STRESS_TEST=true pytest tests/workspace/test_workspace_isolation.py -v

# Custom number of workers (e.g., 10)
ONTORAG_STRESS_TEST=true ONTORAG_TEST_WORKERS=10 pytest tests/workspace/test_workspace_isolation.py -v
```
...
ONTORAG_KEEP_ARTIFACTS=true pytest tests/workspace/test_workspace_isolation.py -v
```
...
2. **Run single test with artifacts:**
   ```bash
   ONTORAG_KEEP_ARTIFACTS=true pytest tests/workspace/test_workspace_isolation.py::test_json_kv_storage_workspace_isolation -v -s
   ```
