"""Unit tests for ``ontorag.utils.validate_workspace``.
...
from ontorag.utils import validate_workspace
...
def _import_document_manager():
    ...
    Importing ``ontorag.api`` modules triggers the server's argparse against
    ...
    try:
        ...
        from ontorag.api.routers.document_routes import DocumentManager
