...
from ontorag.tools.migrate_graph_storage import (
    MigrationDataError,
...
class TestResolvedWorkspace:
    ...
    def test_cli_refuses_env_override_before_touching_the_factory(
        ...
        import ontorag.kg.factory as factory
...
class TestCli:
    ...
    def test_shared_data_is_initialized_before_any_storage_is_built(self, monkeypatch):
        ...
        in ontorag/tools does the same call, so this pins the convention.
        """
    ...
    def test_cli_import_is_offline_safe(self):
        ...
        repo_root = Path(ontorag.__file__).resolve().parents[1]
        code = (
            "import sys\n"
            "import ontorag.tools.migrate_graph_storage as m\n"
