...
async def test_a_destructive_job_in_flight_refuses_the_commit(tmp_path):
    ...
    from ontorag.exceptions import StorageControlPlaneError
    from ontorag.kg.shared_storage import (
        get_namespace_data,
        get_namespace_lock,
        initialize_pipeline_status,
...
async def test_a_contentless_primary_is_refused_offline_too(tmp_path):
    ...
    from ontorag.exceptions import SourceConflictPrimaryUnusableError
...
async def test_the_cli_refuses_to_apply_when_full_docs_cannot_be_opened(
    ...
    import ontorag
    from ontorag.tools import source_conflict_repair as tool
    ...
    monkeypatch.setattr(ontorag, "OntoRAG", _FakeRAG)
...
async def test_the_absent_recovery_hint_matches_what_actually_happened(tmp_path):
    ...
    from ontorag.exceptions import StorageControlPlaneError
    from ontorag.tools.source_conflict_repair import verify_repair_outcome
