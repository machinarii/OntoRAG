...
def _reset_r_separator_caches():
    ...
    """
    from ontorag.multimodal_context import _cached_surrounding_chunk_separators
    from ontorag.parser.routing import _cached_env_r_separators
...
_SPACY_DOWNLOAD_HINT = "ontorag-download-cache --spacy-install"
...
def pytest_configure(config):
    ...
    try:
        from ontorag.parser.routing import smart_heading_default_enabled
