...
and scan routes (``ontorag/api/routers/document_routes.py``) and sidecar
artifact resolution (``ontorag/pipeline.py``, which delegates containment to it
...
from ontorag.utils import validate_file_path_security
