"""Regression tests for :func:`ontorag.utils.pick_by_vector_similarity`.
...
from ontorag.utils import logger as utils_logger
from ontorag.utils import pick_by_vector_similarity
...
async def test_partial_missing_vectors_falls_back_and_warns():
    ...
    # The ontorag logger has propagate=False, so inspect the logger call directly.
