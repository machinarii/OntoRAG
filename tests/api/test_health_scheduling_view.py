...
sys.argv = [sys.argv[0]]
_server = importlib.import_module("ontorag.api.ontorag_server")
_utils_pipeline = importlib.import_module("ontorag.utils_pipeline")
sys.argv = _original_argv

from ontorag.base import DocStatusStorage  # noqa: E402
from ontorag.kg.json_doc_status_impl import JsonDocStatusStorage  # noqa: E402
