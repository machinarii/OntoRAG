...
def test_plaintext_verify_uses_constant_time_comparison():
    ...
    """
    from ontorag.api.passwords import verify_password as verify
...
def _load_api_key_only_modules(monkeypatch):
    ...
    auth = import_real_api_module("ontorag.api.auth")
    auth = importlib.reload(auth)
    utils_api = import_real_api_module("ontorag.api.utils_api")
...
async def test_combined_auth_rejects_guest_token_in_api_key_mode(monkeypatch):
    ...
    try:
        ...
        sys.modules.pop("ontorag.api.utils_api", None)
        sys.modules.pop("ontorag.api.auth", None)
