...
def _isolated_config_env(monkeypatch):
    ...
    The order is load-bearing. Importing ontorag.api.ontorag_server triggers
    ...
    import ontorag.api.ontorag_server  # noqa: F401
...
def create_llm_model_kwargs(_isolated_config_env):
    from ontorag.api.ontorag_server import _create_llm_model_kwargs
