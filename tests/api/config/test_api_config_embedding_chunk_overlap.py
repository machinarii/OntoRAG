...
Independent from CHUNK_OVERLAP_SIZE — see OntoRAG.embedding_chunk_overlap_token_size.
Validation of the parsed value (negative rejection) happens at OntoRAG
...
from ontorag.constants import DEFAULT_EMBEDDING_CHUNK_OVERLAP_TOKEN_SIZE
