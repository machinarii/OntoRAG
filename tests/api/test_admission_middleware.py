...
_shared_storage = importlib.import_module("ontorag.kg.shared_storage")
_admission = importlib.import_module("ontorag.api.admission")
_middleware_mod = importlib.import_module("ontorag.api.admission_middleware")
...
async def test_api_prefix_is_stripped_before_matching():
    ...
    await _mw(rag, downstream, api_prefix="/ontorag")(
        _scope(path="/ontorag/documents/upload"), recorder.receive, recorder.send
    )
