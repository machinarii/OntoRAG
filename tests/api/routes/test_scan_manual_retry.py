...
from ontorag import OntoRAG  # noqa: E402
from ontorag.base import DocStatus  # noqa: E402
from ontorag.kg.pipeline_ingress import (  # noqa: E402
...
from ontorag.utils import EmbeddingFunc, Tokenizer, compute_mdhash_id  # noqa: E402
...
async def _build_rag(tmp_path, extract) -> OntoRAG:
    rag = OntoRAG(
