...
_registry = importlib.import_module("ontorag.parser.registry")
...
def test_cache_headers(client):
    ...
    assert resp.headers["Vary"] == "ONTORAG-WORKSPACE"
...
def test_mineru_routing_splits_allowlist_and_matrix(client, monkeypatch):
    ...
    monkeypatch.setenv("ONTORAG_PARSER", "jpg:mineru;*:legacy-R")
