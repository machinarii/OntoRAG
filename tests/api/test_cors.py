"""
Tests for CORS middleware configuration on the OntoRAG API server.

OntoRAG authenticates exclusively via request headers (Authorization Bearer
...
# import time of ontorag.api.config). Tests must be hermetic and not depend on
...
def _isolate_env(monkeypatch):
    ...
    ontorag.api.config is reset before and after each test so neither developer
