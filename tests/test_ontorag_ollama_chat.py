"""
OntoRAG Ollama Compatibility Interface Test Script

This script tests the OntoRAG's Ollama compatibility interface, including:
...
def create_error_test_data(error_type: str) -> Dict[str, Any]:
    ...
    """
    error_data = {
        "empty_messages": {"model": "ontorag:latest", "messages": [], "stream": True},
        "invalid_role": {
            "model": "ontorag:latest",
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="OntoRAG Ollama Compatibility Interface Testing",
...
Configuration file (config.json):
  {
    "server": {
      ...
      "model": "ontorag:latest" # Default model name
    },
    "test_cases": {
      "basic": {
