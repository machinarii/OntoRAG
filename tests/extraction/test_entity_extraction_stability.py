...
def test_format_parent_headings_per_level_cap_can_be_disabled():
    from ontorag.chunk_schema import format_parent_headings
...
async def test_attach_content_headings_token_budgets_deep_path():
    ...
    from ontorag.chunk_schema import HEADING_BREADCRUMB_SEP
    from ontorag.constants import DEFAULT_MAX_SECTION_CONTEXT_TOKENS
    from ontorag.operate import _attach_content_headings
...
def test_truncate_section_context_noop_within_budget():
    from ontorag.operate import _truncate_section_context
...
async def test_extract_entities_bounds_pathological_heading_in_prompt():
    ...
    from ontorag.chunk_schema import DEFAULT_HEADING_LEVEL_MAX_CHARS
    from ontorag.operate import extract_entities
...
def test_clean_heading_text_converts_arrow_to_space():
    ...
    from ontorag.chunk_schema import _clean_heading_text
