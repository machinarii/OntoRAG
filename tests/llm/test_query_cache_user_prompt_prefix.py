...
from ontorag.base import QueryContextResult, QueryParam
from ontorag.operate import kg_query, naive_query
...
def stub_query_context(monkeypatch):
    ...
    monkeypatch.setattr(
        "ontorag.operate._build_query_context", _fake_build_query_context
    )
