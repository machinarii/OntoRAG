...
ontorag/llm/hf.py imports transformers and torch at module level. Neither
...
def make_hf_module(
    ...
    sys.modules.pop("ontorag.llm.hf", None)
    hf_module = importlib.import_module("ontorag.llm.hf")
...
async def test_generation_token_limit_precedence(
    ...
    """The HF-native setting wins over OntoRAG's generic alias, while
