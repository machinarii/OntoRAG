...
in-place by ontorag.utils.update_chunk_cache_list) cannot corrupt internal
storage state without going through upsert."""

import pytest

from ontorag.kg.json_kv_impl import JsonKVStorage
from ontorag.kg.shared_storage import initialize_share_data, finalize_share_data
...
async def test_update_chunk_cache_list_does_not_corrupt_storage_on_read(tmp_path):
    ...
    """
    from ontorag.utils import update_chunk_cache_list
