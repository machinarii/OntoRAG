...
async def _build_postgres(_tmp_path) -> Any:
    from ontorag.kg.postgres_impl import ClientManager, PGDocStatusStorage
...
async def _build_mongo(_tmp_path) -> Any:
    from ontorag.kg.mongo_impl import MongoDocStatusStorage
...
async def _build_opensearch(_tmp_path) -> Any:
    from ontorag.kg.opensearch_impl import OpenSearchDocStatusStorage
