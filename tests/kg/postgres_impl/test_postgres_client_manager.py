...
def test_only_pg_vector_storage_enables_vector() -> None:
    ...
    from ontorag.kg import STORAGE_IMPLEMENTATIONS
...
async def test_pg_vector_storage_declares_its_own_pgvector_requirement() -> None:
    ...
    storage.table_name = "ONTORAG_VDB_CHUNKS"
    storage.legacy_table_name = "ONTORAG_VDB_CHUNKS"
    ...
    with (
        ...
        patch("ontorag.kg.postgres_impl.get_data_init_lock", return_value=_lock()),
