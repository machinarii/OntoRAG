...
create — so a create that did not land left ONTORAG_DOC_STATUS with NO
...
_NEW = "idx_ontorag_doc_status_ws_status_created_nf_id"
_SUPERSEDED = "idx_ontorag_doc_status_ws_status_created_id"
