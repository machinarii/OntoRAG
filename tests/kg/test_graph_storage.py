...
backend under test (ONTORAG_GRAPH_STORAGE, defaulting to NetworkXStorage) and
...
# ontorag package from the active virtualenv.
sys.path.insert(
    0,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "ONTORAG_GRAPH_STORAGE. A thin wrapper around pytest: the tests run "
