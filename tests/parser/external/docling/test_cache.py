"""Tests for ``ontorag/parser/external/docling/cache.py``.
...
from ontorag.parser.external import Manifest, ManifestFile, write_manifest
from ontorag.parser.external._common import compute_size_and_hash
