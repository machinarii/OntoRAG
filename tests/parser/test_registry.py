"""Unit tests for the parser registry (ontorag.parser.registry)."""
...
def test_docling_additional_suffixes_are_routable():
    ...
    code = (
        "from ontorag.parser import registry; "
        "from ontorag.parser.routing import validate_parser_routing_config; "
...
def test_wellformed_env_suffixes_pass_startup_validation(
    ...
    from ontorag.parser.routing import validate_parser_suffix_env_vars
...
def test_capability_queries_do_not_import_parser_impls():
    ...
    code = (
        "import sys; import ontorag.parser.registry as r; "
        ...
        "assert 'ontorag.parser.external.mineru.parser' not in sys.modules; "
        "print('clean')"
    )
