...
def test_docling_snapshot_and_signature_reflect_force_ocr():
    from ontorag.parser.external.docling.cache import (
        compute_options_signature,
        snapshot_tunable_env,
    )
    from ontorag.parser.external.docling.client import FIXED_CONSTANTS
...
def test_docling_client_reflects_force_ocr_override(monkeypatch):
    ...
    from ontorag.parser.external.docling.client import DoclingRawClient
