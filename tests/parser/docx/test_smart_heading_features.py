...
def test_revision_skip_matches_body_parser() -> None:
    ...
    from ontorag.parser.docx.parse_document import _SKIP_PARAGRAPH_TAGS
    from ontorag.parser.docx.smart_heading.features import _SKIP_REVISION_SUBTREES
...
def test_bare_sz_does_not_mask_valid_szcs() -> None:
    ...
    from ontorag.parser.docx.smart_heading.features import _element_direct_size
...
def test_toc_entry_field_reference_flags_toc(tmp_path) -> None:
    ...
    from ontorag.parser.docx.smart_heading.features import _is_toc_instr
